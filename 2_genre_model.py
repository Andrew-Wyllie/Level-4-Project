####Binary classifcation between classical and blues with 4 fully connected layers
...
num_classes = 2 ##genres to be seperated
learning_rate = 0.001
batch_size = 10
epochs = 10

##retriving data
train_dir = r'/content/gdrive/My Drive/Colab Notebooks/genre/data/images_original/train2'
test_dir = r'/content/gdrive/My Drive/Colab Notebooks/genre/data/images_original/test2'
...
with torch.no_grad():
    ...
    f1_score = f1_score(true_list, predicted_list)
...
sns.heatmap(conf_matrix, 
            annot=True,
            fmt='g', 
            xticklabels=['Blues','Classical'],
            yticklabels=['Blues','Classical'])
